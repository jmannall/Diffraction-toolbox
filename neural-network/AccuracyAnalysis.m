...
for i = 2:numFields
    field = fields{i};
    figure
    PlotVarDependentLoss(lossN.i.(field), wL, 1, percentiles, ['wL: ', field], 1)
end
...
for i = 2:numFields
    field = fields{i};
    figure
    PlotVarDependentLoss(lossN.i.(field), mA(wL > wLMin), 1, percentiles, ['mA: ', field], i)
end
...
for i = 2:numFields
    field = fields{i};
    figure
    PlotVarDependentLoss(lossN.i.(field), bA(wL > wLMin), 1, percentiles, ['bA: ', field], i)
end
...
for i = 2:numFields
    field = fields{i};
    figure
    PlotVarDependentLoss(lossN.i.(field), wI(wL > wLMin), 1, percentiles, ['wI: ', field], i)
end
...
for i = 2:numFields
    field = fields{i};
    figure
    PlotVarDependentLoss(lossN.i.(field), pathLength(wL > wLMin), 1, percentiles, ['L: ', field], i)
end
