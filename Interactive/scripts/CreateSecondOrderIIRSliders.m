function S = CreateSecondOrderIIRSliders(S)
    ...
    width = 500;
    height = 40;
    S.dcLabel = CreateLabel(x, 760, width, height);
    S.nyqLabel = CreateLabel(x, 680, width, height);
    S.B0Label = CreateLabel(x, 600, width, height);
    S.fcLabel = CreateLabel(x, 520, width, height);
    S.f1Label = CreateLabel(x, 440, width, height);
    S.f2Label = CreateLabel(x, 360, width, height);
    S.B1Label = CreateLabel(x, 280, width, height);
end