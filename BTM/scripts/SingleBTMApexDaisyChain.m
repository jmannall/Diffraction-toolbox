function [tfmag, fvec, tfcomplex] = SingleBTMApexDaisyChain(source, receiver, apex, corners, planeCorners, controlparameters, data, withCorrection, createPlot)
    ...
    for i = 1:numEdges
        ...
        tfcomplex(:,i) = (rS(i) + rR(i)) * scale(i) * tfcomplexStore.diff1;
    end
