function [tfmag, fvec, tfcomplex] = UTDSingleApexDaisyChainV2(data, phi, always, c, controlparameters, withCorrection)
    ...
    for i = 1:numEdges
        [~, fvec, tfcomplexStore] = UTDSingleWedge(thetaS(i), thetaR(i), rS(i), rR(i), wedgeIndex(i), phi, controlparameters);
